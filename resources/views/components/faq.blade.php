...
<section class="py-20 relative bg-stone-50 border-b border-slate-200 swiss-pattern-lines">
  ...
  <div class="container mx-auto px-4 relative z-10">
    <div class="text-center mb-16 relative">
      ...
      <h2 class="text-3xl md:text-4xl font-bold mb-4 tracking-tight font-serif" style="color: #243468;">Частые вопросы
      </h2>
      <p class="text-base max-w-2xl mx-auto text-slate-700 font-light">Ответы на самые популярные вопросы о работе с
        задолженностью</p>
    </div>
      ...
      <div class="max-w-3xl mx-auto bg-white border border-slate-200 rounded-none" x-data="{ active: null }">
        @foreach($faqs as $index => $faq)
          <div class="border-b last:border-b-0 border-slate-200">
            ...
            <div x-show="active === {{ $index }}" x-cloak class="overflow-hidden"
