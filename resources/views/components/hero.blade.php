...
<section class="border-b border-slate-200 swiss-pattern-dots relative overflow-hidden">
  ...
  <div class="absolute inset-0"
    style="background-image: url('{{ asset('images/background-2.png') }}'); background-size: cover; background-position: center; background-repeat: no-repeat; transform: scale(1.05);">
  </div>
  <div class="absolute inset-0"
  ...
  <div class="absolute inset-0"
    style="background: radial-gradient(ellipse 80% 70% at center, rgba(255,255,255,0.92) 0%, rgba(255,255,255,0.78) 50%, rgba(255,255,255,0.65) 100%);">
  </div>
  ...
  <div class="container mx-auto px-6 lg:px-12 py-20 lg:py-32 relative z-10">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="flex flex-col items-center gap-6 mb-12">
        <button type="button" @click="$dispatch('open-lead-modal')"
        ...
        <p class="text-sm text-slate-600 max-w-md">
          Вы получите <strong class="text-slate-900">бесплатный правовой анализ</strong> вашей ситуации. Это ни к чему
          не обязывает.
        </p>
      </div>
      ...
      <div class="mt-16 pt-8 border-t border-slate-200">
        <div class="flex flex-col items-center justify-center gap-3">
          <div class="flex items-center gap-1">
            @for($s = 1; $s <= 5; $s++)
              <svg class="w-5 h-5 fill-amber-400" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
              </svg>
            @endfor
          </div>
          <p class="text-xs font-medium uppercase tracking-widest text-slate-700 text-center">
