    ...
    <main>
      ...
      <section class="py-16 md:py-24 relative bg-stone-50 border-b border-slate-200 swiss-pattern-lines">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          <div
            class="grid sm:grid-cols-2 lg:grid-cols-4 gap-0 max-w-6xl mx-auto border border-slate-200 rounded-none overflow-hidden">
            <div
              class="p-8 bg-white border-b sm:border-b-0 sm:border-r border-slate-200 last:border-r-0 flex flex-col items-center text-center">
              ...
              <a href="tel:{{ preg_replace('/\D/', '', $contactPhone) }}"
                class="font-bold text-slate-900 hover:opacity-80 transition-opacity mb-1"
                style="color: #243468;">{{ $contactPhone }}</a>
            ...
            <div
              ...
              <a href="mailto:{{ $contactEmail }}"
                class="font-bold text-slate-900 hover:opacity-80 transition-opacity mb-1"
                style="color: #243468;">{{ $contactEmail }}</a>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          <div class="max-w-3xl mx-auto">
            <div class="mb-12 text-center relative">
              ...
              <h2 class="text-3xl md:text-4xl font-bold tracking-tight font-serif mb-4" style="color: #243468;">Оставьте
                заявку</h2>
              ...
              <form action="{{ route('leads.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                  <label for="contact_phone"
                    class="block text-sm font-bold uppercase tracking-wider text-slate-700 mb-1">Ваш телефон</label>
                  <input type="tel" name="phone" id="contact_phone" required placeholder="+7 (999) 123-45-67"
                    class="w-full rounded-none border border-slate-300 px-4 py-3 text-lg focus:ring-2 focus:ring-slate-900 focus:border-slate-900" />
                  @error('phone')<p class="text-sm text-red-600 mt-1">{{ $message }}</p>@enderror
                </div>
                <div>
                  <label for="contact_name"
                    class="block text-sm font-bold uppercase tracking-wider text-slate-700 mb-1">Имя</label>
                  <input type="text" name="name" id="contact_name" required placeholder="Ваше имя"
                    class="w-full rounded-none border border-slate-300 px-4 py-3 focus:ring-2 focus:ring-slate-900 focus:border-slate-900" />
                ...
                <button type="submit"
                  class="w-full text-white text-base font-bold py-4 rounded-none uppercase tracking-wider transition-opacity hover:opacity-90"
                  style="background-color: #ED3200;">Получить бесплатный разбор</button>
              </form>
              <p class="text-xs text-slate-600 text-center mt-4">Ваш номер нужен <strong
                  class="text-slate-900">только</strong> для разбора ситуации юристом. Мы никому не передаем данные.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          <div class="max-w-5xl mx-auto">
            <div class="mb-12 text-center relative">
              ...
              <h2 class="text-3xl md:text-4xl font-bold tracking-tight font-serif mb-4" style="color: #243468;">Мы
                работаем по всей России</h2>
              <p class="text-slate-600">Более 200 городов в 85 регионах страны</p>
            </div>
            <div
              class="aspect-video bg-slate-200 border border-slate-200 rounded-none overflow-hidden flex items-center justify-center text-slate-600">
              <div class="text-center">
                <div
                  class="h-16 w-16 rounded-none border-2 border-slate-900 flex items-center justify-center mx-auto mb-4">
